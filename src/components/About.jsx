    ...
    return (
        <div className="p-10 bg-main-back2 rounded-xl shadow-lg relative mt-10 bg-gradient-to-r from-purple-800 to-blue-800 p-4">
            ...
            <footer className="flex  items-center py-4">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" className="w-5 h-5 m-3">
                ...
                <a href="https://github.com/myusername/myrepository" target="_blank" rel="noopener noreferrer" className="flex items-center text-white p-2 shadow-[0_9px_0_rgb(0,0,0)] hover:shadow-[0_4px_0px_rgb(0,0,0)] text-black bg-white ease-out hover:translate-y-1 transition-all rounded">
                    View on GitHub
                </a>
