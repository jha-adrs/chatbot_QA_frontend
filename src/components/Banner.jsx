    ...
    return (
        ...
        {...props}>
            ...
            <div className="flex items-center flex-shrink-0">
                ...
                <Link href="/chat" className="inline-flex items-center justify-center px-3 py-2 mr-2 text-xs font-medium text-white bg-primary-500 rounded-lg hover:bg-primary-700 focus:ring-4 focus:ring-gray-300 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-gray-800">Get started <svg className="w-3 h-3 ml-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
