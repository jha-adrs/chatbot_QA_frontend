                            ...
                            <tr>
                                <td colSpan="5" className="px-6 py-4">
                                    <div className="flex justify-between">
                                        <button onClick={()=> handlePagination('prev')} className=" text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center bg-primary-600 hover:bg-primary-700 focus:ring-primary-800 p-10 rounded-lg shadow-[0_9px_0_rgb(0,0,0)] hover:shadow-[0_4px_0px_rgb(0,0,0)]  ease-out hover:translate-y-1 transition-all " disabled={isLoading||prevDisabled}>
                                            Prev</button>
                                        <button onClick={()=> handlePagination('next')} className=" text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center bg-primary-600 hover:bg-primary-700 focus:ring-primary-800 p-10 rounded-lg shadow-[0_9px_0_rgb(0,0,0)] hover:shadow-[0_4px_0px_rgb(0,0,0)]  ease-out hover:translate-y-1 transition-all " disabled={isLoading || nextDisabled}>
                                            Next</button>
                                    </div>
                                </td>
                            </tr>
                        ...
                        <>
                            <tbody>
                                ...
                                <tr>
                                    <td colSpan="5" className="px-6 py-4">
                                        <div className="flex justify-between">
                                            <button onClick={()=> handlePagination('prev')} className=" text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center bg-primary-600 hover:bg-primary-700 dark:focus:ring-primary-800 p-10  shadow-[0_9px_0_rgb(0,0,0)] hover:shadow-[0_4px_0px_rgb(0,0,0)]  ease-out hover:translate-y-1 transition-all " disabled={isLoading || prevDisabled}>
                                                Prev</button>
                                            <button onClick={()=> handlePagination('next')} className=" text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center bg-primary-600 hover:bg-primary-700 dark:focus:ring-primary-800 p-10  shadow-[0_9px_0_rgb(0,0,0)] hover:shadow-[0_4px_0px_rgb(0,0,0)]  ease-out hover:translate-y-1 transition-all " disabled={isLoading || nextDisabled}>
                                                Next</button>
                                        </div>
                                    </td>
                                </tr>
